...
import Control.AddDriver;
import Control.AllBus;
import Control.Detail;
import Control.DviewAll;
...
public class AdminControl extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnDrivers = new JMenu("Drivers");
        jMenuBar2.add(mnDrivers);
        
        mntmViewAll = new JMenuItem("View All");
        mnDrivers.add(mntmViewAll);
        
        mntmViewAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	mntmViewAllActionPerformed(evt);
            }
        });
        
        mntmAddDriver = new JMenuItem("Add driver");
        mnDrivers.add(mntmAddDriver);
        
        mntmAddDriver.setText("Add Driver");
        mntmAddDriver.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	mntmAddDriverActionPerformed(evt);
            }
        });
   ...
   //     Welcome w=new Welcome();
    ...
    private void mntmAddDriverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        AddDriver aa=new AddDriver();
        jDesktopPane1.add(aa);
        aa.show();
    }
    private void mntmViewAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        DviewAll aa=new DviewAll();
        jDesktopPane1.add(aa);
        aa.show();
    }
    ...
    private javax.swing.JMenu mnDrivers;
    private javax.swing.JMenuItem mntmAddDriver;
    private javax.swing.JMenuItem mntmViewAll;
