...
public class DriverLogin extends JFrame {
	...
	public DriverLogin() {
		...
		JLabel lblUserLogin = new JLabel("Driver Login");
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String filename="AddD.txt";
			boolean valid =logic.validationDriver(textField.getText().toString( ),passwordField.getText(), filename);
			if (valid) {
				JOptionPane.showMessageDialog(getParent(), "WELCOME!");
				UserControl2 p= new UserControl2(textField.getText());
