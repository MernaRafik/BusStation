    ...
    public NewBooking(String u) {
        ...
        Scanner rs;
                        try
                        {
                            ...
                            while(rs.hasNext())
                            {
                                model.addRow(new Object[]{rs.next(),rs.next(),rs.next(),rs.next(),rs.next(),rs.next()});
                            } 
                ...
                if(i==1)
                {
                    ...
                    if(j==1)
                    {
                       ...
                       Scanner r; 
                             try
                             {
                             	r= new Scanner(new File("Trips.txt"));
                             	DefaultTableModel model2=(DefaultTableModel) jTable4.getModel();
                                 while(r.hasNext())
                                 {
                                     model2.addRow(new Object[]{r.next(),r.next(),r.next(),r.next(),r.next(),r.next()});
                                 } 
